 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li><a href="../admin/index.php">Social Panel</a></li>
                  <li><a href="../bs_index.php">Blog</a></li>

                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Hello <?php  echo $username; ?> <b class="caret"></b></a>
    ...
    $role = $row['blog_user_role']; 
        if($role == "Admin") {
            ...
            echo "<li>"."<a href='users.php'>Add New Users</a>"."</li>";
        } else {
            echo "<li>"."<a href='view_users.php'>View All Users</a>"."</li>";
        }
