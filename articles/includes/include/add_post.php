...
<div class="row">
	...
	<div class="form-group">
		...
		<input type="text" value="<?php echo $_SESSION['user_name'];?>" name="author" placeholder="Post Author" class="form-control" >
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="file" name="myfile" class="form-control">
			...
			<div class="form-group">
			<b>Note:</b> <p>Article will be sent for Admin Approvel, After Admin Approvel you can view your article on Articles Page.</p>
			</div>
		<div class="form-group">
