		...
		if($content=="No" && strlen($upload_image) >= 1){
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					...
					<a href='deleteposts.php?post_id=$post_id' style='float:right;' class='btn btn-danger'><span class='glyphicon glyphicon-trash'></span> Delete</a><br>
				</div>
				<div class='col-sm-3'>
				</div>
			</div><br><br>
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					...
					<div class='row'>
						...
						<a href='deleteposts.php?post_id=$post_id' style='float:right;' class='btn btn-danger'><span class='glyphicon glyphicon-trash'></span> Delete</a>
		...
		<div class='row'> 
			<div class='col-md-6 col-md-offset-3'>
				<div class='panel panel-info'>
					...
					<button class='btn btn-info pull-right' name='reply'>
						Comment
					</button>
					</form>
					</div>
						...
						<div class='col-sm-4'>
							...
							<img src='../users/$user_image' width='150px' height='140px' title='$username' style='float:left; , margin:1px;'/>
								...
								<div class='col-sm-6'>
									...
									<div class='col-sm-3'>
									<a href='deleteuser.php?u_id=$user_id' style='float:right;' class='btn btn-danger'><span class='glyphicon glyphicon-trash'></span> Delete</a>
									</div>
					</div>
				</div>
									<div class='col-sm-4'>
