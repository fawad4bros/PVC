...
include("connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		values('$first_name','$last_name','$username','Hello PVC.This is my default status!','','$pass','$email','$country','$gender','$birthday','$profile_pic','../cover/cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
