...
(isset($_GET['cat_id'])) ? $cat_id = $_GET['cat_id']: header("Location: ../articles.php");
$query= "SELECT * FROM blog_posts WHERE blog_post_cat_id = $cat_id ORDER BY blog_post_id DESC ";
